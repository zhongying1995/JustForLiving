...
function CreateNeutralPassive takes nothing returns nothing
    ...
    local trigger t
    local real life
    set u=CreateUnit(p, 'h600', 4162.9, 170.4, 340.795)
    set u=CreateUnit(p, 'h600', 4413.4, 107.9, 143.354)
    set u=CreateUnit(p, 'h600', 4170.5, - 279.7, 232.676)
    set u=CreateUnit(p, 'h600', 3759.1, - 173.3, 59.954)
    set u=CreateUnit(p, 'h600', 3957.5, 34.2, 286.104)
    set u=CreateUnit(p, 'h600', 3453.1, - 47.3, 329.973)
    set u=CreateUnit(p, 'h600', 3731.1, 8.0, 150.671)
    set u=CreateUnit(p, 'h600', 3599.2, - 153.4, 164.525)
    set u=CreateUnit(p, 'h600', 3583.3, - 242.3, 95.463)
    set u=CreateUnit(p, 'h600', 3227.7, - 301.2, 219.536)
    set u=CreateUnit(p, 'h600', 3245.0, - 60.8, 106.659)
    set u=CreateUnit(p, 'h600', 3184.2, 62.0, 162.185)
    set u=CreateUnit(p, 'h600', 3033.5, - 70.5, 355.627)
    set u=CreateUnit(p, 'h600', 3009.8, - 230.9, 230.676)
    set u=CreateUnit(p, 'h600', 2923.5, 104.0, 201.561)
    set u=CreateUnit(p, 'h600', 3011.4, 151.7, 77.379)
endfunction
//===========================================================================
